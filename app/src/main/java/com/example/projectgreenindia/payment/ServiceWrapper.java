...
import com.example.projectgreenindia.BuildConfig;
...
//            HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor();
    ...
    {
        return mServiceInterface.getHashCall(convertPlainString(key), convertPlainString(txtid),convertPlainString(amount),
